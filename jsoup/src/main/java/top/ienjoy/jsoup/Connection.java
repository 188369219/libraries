...
/**
 ...
 into Documents.
 <p>To start a new session, use either {@link top.ienjoy.jsoup.Jsoup#newSession()} or {@link top.ienjoy.jsoup.Jsoup#connect(String)}.
...
public interface Connection {
     ...
     * @return this Connection, for chaining
     * @see top.ienjoy.jsoup.helper.HttpConnection#DEFAULT_UA
     */
     ...
     * @return this Connection, for chaining
     * @see top.ienjoy.jsoup.Connection.Request#header(String, String)
     * @see top.ienjoy.jsoup.Connection.Request#headers()
     */
    ...
    interface Base<T extends Base<T>> {
         ...
         * @return a map of multiple values per header.
         */
