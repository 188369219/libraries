...
import static top.ienjoy.jsoup.internal.StringUtil.inSorted;
import static top.ienjoy.jsoup.parser.HtmlTreeBuilderState.Constants.InTableFoster;
    ...
    List<Node> parseFragment(String inputFragment, @Nullable Element context, String baseUri, Parser parser) {
        ...
        if (context != null) {
            ...
            switch (contextTag) {
                ...
                case "iframe", "noembed", "noframes", "style", "xml" ->
                ...
                default -> tokeniser.transition(TokeniserState.Data);
            }
