...
import top.ienjoy.jsoup.internal.Normalizer;
...
public final class DataUtil {
        ...
        try {
            ...
            if (charsetName == null) { // determine from meta. safe first parse as UTF-8
                ...
                if (foundCharset == null && doc.childNodeSize() > 0) {
                    ...
                    else if (first instanceof Comment comment) {
            ...
            if (doc == null) {
                ...
                try (BufferedReader reader = new BufferedReader(new InputStreamReader(input, Charset.forName(charsetName)), bufferSize)) {
    ...
    private @Nullable
    static String validateCharset(@Nullable String cs) {
