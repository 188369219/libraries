...
import static top.ienjoy.jsoup.internal.Normalizer.lowerCase;
import static top.ienjoy.jsoup.internal.Normalizer.normalize;
import static top.ienjoy.jsoup.internal.StringUtil.normaliseWhitespace;
...
import top.ienjoy.jsoup.nodes.Comment;
import top.ienjoy.jsoup.nodes.Document;
import top.ienjoy.jsoup.nodes.DocumentType;
import top.ienjoy.jsoup.nodes.Element;
import top.ienjoy.jsoup.nodes.Node;
import top.ienjoy.jsoup.nodes.PseudoTextElement;
import top.ienjoy.jsoup.nodes.TextNode;
import top.ienjoy.jsoup.nodes.XmlDeclaration;
...
public abstract class Evaluator {
    ...
    public static final class AttributeStarting extends Evaluator {
        ...
        @Override
        public boolean matches(Element root, Element element) {
            List<top.ienjoy.jsoup.nodes.Attribute> values = element.attributes().asList();
            for (top.ienjoy.jsoup.nodes.Attribute attribute : values) {
    ...
    public static final class AttributeWithValueMatching extends Evaluator {
        ...
        @Override
        public String toString() {
            return String.format("[%s~=%s]", key, pattern);
        }
    ...
    public static final class IndexLessThan extends IndexEvaluator {
        ...
        @Override
        public String toString() {
            return String.format(Locale.getDefault(), ":lt(%d)", index);
        }
    ...
    public static final class IndexGreaterThan extends IndexEvaluator {
        ...
        @Override
        public String toString() {
            return String.format(Locale.getDefault(), ":gt(%d)", index);
        }
    ...
    public static final class IndexEquals extends IndexEvaluator {
        ...
        @Override
        public String toString() {
            return String.format(Locale.getDefault(), ":eq(%d)", index);
        }
    ...
    public static abstract class CssNthEvaluator extends Evaluator {
        ...
        public String toString() {
            if (a == 0)
                return String.format(Locale.getDefault(), ":%s(%d)", getPseudoClass(), b);
            if (b == 0)
                return String.format(Locale.getDefault(), ":%s(%dn)", getPseudoClass(), a);
            return String.format(Locale.getDefault(), ":%s(%dn%+d)", getPseudoClass(), a, b);
        }
        ...
        public boolean matches(Element root, Element element) {
            ...
            for (TextNode textNode : textNodes) {
                PseudoTextElement pel = new PseudoTextElement(
                        top.ienjoy.jsoup.parser.Tag.valueOf(element.tagName()), element.baseUri(), element.attributes());
