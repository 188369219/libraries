...
public abstract class Node implements Cloneable {
    ...
    private void addSiblingHtml(int index, String html) {
        ...
        List<Node> nodes = EmptyNodes;
        if (context != null) {
            nodes = NodeUtils.parser(this).parseFragmentInput(html, context, baseUri());
        }
        ...
        Element context =
            parentNode != null && parentNode instanceof Element ? (Element) parentNode :
                this instanceof Element ? (Element) this :
                    null;
        List<Node> wrapChildren = EmptyNodes;
        if (context != null) {
            wrapChildren = NodeUtils.parser(this).parseFragmentInput(html, context, baseUri());
        }
        Node wrapNode = wrapChildren.get(0);
        if (!(wrapNode instanceof Element wrap)) // nothing to wrap with; noop
            return this;
     ...
     * @see top.ienjoy.jsoup.nodes.Element#elementSiblingIndex()
     */
