...
import top.ienjoy.jsoup.helper.DataUtil;
...
public class Document extends Element {
    ...
    /**
     ...
     @see top.ienjoy.jsoup.Jsoup#parse
     @see #createShell
     */
    ...
    private void ensureMetaCharsetElement() {
        if (updateMetaCharset) {
            ...
            if (syntax == OutputSettings.Syntax.html) {
                ...
                Objects.requireNonNullElseGet(metaCharset, () -> head().appendElement("meta")).attr("charset", charset().displayName());
