package top.ienjoy.jsoup.safety;
...
import top.ienjoy.jsoup.parser.ParseErrorList;
...
/**
 ...
 <p>
 Rather than interacting directly with a Cleaner object, generally see the {@code clean} methods in {@link top.ienjoy.jsoup.Jsoup}.
 </p>
 */
public class Cleaner {
    ...
    private final class CleaningVisitor implements NodeVisitor {
        ...
        public void head(Node source, int depth) {
            if (source instanceof Element sourceEl) {
            ...
            } else if (source instanceof DataNode sourceData && safelist.isSafeTag(source.parent().nodeName())) {
