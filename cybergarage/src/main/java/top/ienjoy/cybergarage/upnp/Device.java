...
import top.ienjoy.cybergarage.soap.SOAPResponse;
...
import top.ienjoy.cybergarage.upnp.control.ControlRequest;
...
import top.ienjoy.cybergarage.upnp.device.Advertiser;
import top.ienjoy.cybergarage.upnp.device.Description;
import top.ienjoy.cybergarage.upnp.device.InvalidDescriptionException;
import top.ienjoy.cybergarage.upnp.device.NTS;
import top.ienjoy.cybergarage.upnp.device.PresentationListener;
...
import top.ienjoy.cybergarage.upnp.ssdp.SSDPSearchResponse;
import top.ienjoy.cybergarage.upnp.ssdp.SSDPSearchResponseSocket;
import top.ienjoy.cybergarage.upnp.ssdp.SSDPSearchSocketList;
import top.ienjoy.cybergarage.upnp.xml.DeviceData;
import top.ienjoy.cybergarage.util.Debug;
import top.ienjoy.cybergarage.util.Mutex;
import top.ienjoy.cybergarage.util.TimerUtil;
...
public class Device implements HTTPRequestListener, SearchListener {
    ...
    public boolean isDevice(String name) {
        ...
        if (name.equals(getFriendlyName()))
            return true;
        return name.endsWith(getDeviceType());
    }
