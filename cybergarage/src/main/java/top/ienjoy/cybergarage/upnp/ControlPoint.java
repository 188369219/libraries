...
import top.ienjoy.cybergarage.http.HTTPRequestListener;
import top.ienjoy.cybergarage.http.HTTPServerList;
import top.ienjoy.cybergarage.net.HostInterface;
import top.ienjoy.cybergarage.upnp.control.RenewSubscriber;
import top.ienjoy.cybergarage.upnp.device.DeviceChangeListener;
import top.ienjoy.cybergarage.upnp.device.Disposer;
import top.ienjoy.cybergarage.upnp.device.NotifyListener;
import top.ienjoy.cybergarage.upnp.device.ST;
import top.ienjoy.cybergarage.upnp.device.SearchResponseListener;
import top.ienjoy.cybergarage.upnp.device.USN;
import top.ienjoy.cybergarage.upnp.event.EventListener;
import top.ienjoy.cybergarage.upnp.event.NotifyRequest;
import top.ienjoy.cybergarage.upnp.event.Property;
import top.ienjoy.cybergarage.upnp.event.PropertyList;
import top.ienjoy.cybergarage.upnp.event.Subscription;
import top.ienjoy.cybergarage.upnp.event.SubscriptionRequest;
import top.ienjoy.cybergarage.upnp.event.SubscriptionResponse;
import top.ienjoy.cybergarage.upnp.ssdp.SSDP;
import top.ienjoy.cybergarage.upnp.ssdp.SSDPNotifySocketList;
import top.ienjoy.cybergarage.upnp.ssdp.SSDPPacket;
import top.ienjoy.cybergarage.upnp.ssdp.SSDPSearchRequest;
import top.ienjoy.cybergarage.upnp.ssdp.SSDPSearchResponseSocketList;
import top.ienjoy.cybergarage.util.Debug;
import top.ienjoy.cybergarage.util.ListenerList;
import top.ienjoy.cybergarage.util.Mutex;
import top.ienjoy.cybergarage.xml.Node;
import top.ienjoy.cybergarage.xml.NodeList;
...
public class ControlPoint implements HTTPRequestListener {
    ...
    private synchronized void addDevice(SSDPPacket ssdpPacket) {
        ...
        } catch (MalformedURLException | ParserException me) {
